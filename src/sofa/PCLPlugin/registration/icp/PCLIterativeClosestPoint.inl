...
PCLIterativeClosestPoint::PCLIterativeClosestPoint()
    ...
    ), d_translation(initData(&d_translation, defaulttype::Vector3(0,0,0), "translation", "translation vector"))
    , d_verbose (initData(&d_verbose, false, "verbose", "true for verbose, false otherwise"))
